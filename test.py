...
#     print(f"Creating logger for: {__name__}")
#     main()
...
#     ref_path = Path("D:\LLMOPS\DOCUMENT_PORTAL\data\document_compare\Long_Report_V2.pdf")
#     #act_path = Path("C:\\Complete_Content2\\llmops_batch\\document_portal\\data\\document_compare\\Long_Report_V2.pdf")
#     act_path = Path("D:\LLMOPS\DOCUMENT_PORTAL\data\document_compare\Long_Report_V1.pdf")
